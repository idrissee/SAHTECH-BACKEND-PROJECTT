...
public class RecommendationServiceImpl implements RecommendationService {
    ...
    private Map<String, Object> callAiService(Utilisateurs utilisateur, Produit produit) {
        ...
        userData.put("objectives", List.of()); // Default empty list if not available in entity
        ...
        productData.put("name", produit.getNom());
        ...
        if (produit.getIngredients() != null) {
            ingredientNames = produit.getIngredients().stream()
                .map(ingredient -> ingredient.getNomIngrediant().toString())
                .toList();
        }
