...
public class NutrisionisteDto extends UtilisateursDto {
    ...
    public NutrisionisteDto(String id, String nom, String prenom, Long numTelephone,
        ...
        super(id, nom, prenom, numTelephone, email, dateDeNaissance, maladies,
              poids, taille, sport, sexe, allergies, password, objectives,
              healthGoals, provider, hasChronicDisease, hasAllergies,
              preferredLanguage, physicalActivities, photoUrl);
